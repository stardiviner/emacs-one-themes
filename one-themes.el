...
(defmacro one-themes-with-color-variables (variant &rest body)
  ...
  `(let* ((colors (cdr (assoc ,variant one-themes-colors)))
          ...
          (bright (cdr (assoc 'bright colors)))
...
(defun one-themes-create-theme (variant theme-name)
  ...
  (one-themes-with-color-variables
    ...
    ;;;; references etc.
     ...
     `(org-block ((,class (:background ,low-contrast-bg :extend t))))
     `(org-block-background ((,class (:background ,low-contrast-bg :extend t))))
     ...
     `(org-level-5 ((,class (:inherit org-level-1 :foreground ,orange2))))
     `(org-level-6 ((,class (:inherit org-level-1 :foreground ,green))))
     `(org-level-7 ((,class (:inherit org-level-1 :foreground ,violet))))
     `(org-level-8 ((,class (:inherit org-level-1 :foreground ,cyan))))
