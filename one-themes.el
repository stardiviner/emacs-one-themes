...
(defun one-themes-create-theme (variant theme-name)
  ...
  (one-themes-with-color-variables
    ...
    ;;;; references etc.
     ...
     `(org-level-5 ((,class (:inherit org-level-1 :foreground ,cyan))))
     `(org-level-6 ((,class (:inherit org-level-1 :foreground ,orange2))))
     `(org-level-7 ((,class (:inherit org-level-1 :foreground ,green))))
     `(org-level-8 ((,class (:inherit org-level-1 :foreground ,red2))))
